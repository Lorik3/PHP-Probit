...
<div class="main-content">
    <div class="wrapper">
        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>Title:</td>
                <td><input type="text"name="title"placeholder="Titulli"></td>
            </tr>
            ...
            <tr>
                <td>Price:</td>
                    ...
                    <tr>
                     ...
                     <?php
                            //mi paraqit prej databazes kategorit
                            ...
                            {
                                ?>
                                <option value="0">Nuk u gjend asnje kategori</option>
                                <?php
                            }
